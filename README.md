...
### 🏠 Score Logement (40% du score total)
...
### 💰 Score Revenus (30% du score total)
...
### 📈 Score Taille du Marché (30% du score total)
...
```
Score_Total = (Score_Logement × 0.40) + 
              (Score_Revenus × 0.30) + 
              (Score_TailleMaché × 0.30)
```
...
- **Carte Interactive** : Visualisation géographique des zones avec 3 types de cartes
  - Carte Folium avec marqueurs
  - Carte scatter Plotly  
  - Heatmap de densité
